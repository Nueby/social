...
$(document).ready(function() {
	for(var i = 1;i<$("#report_page tr").length;i++){
		// reportChat[i].click(function(){
		// 	$("#outrecord").show();
		// })
		console.log(reportChat[0].innerHTML);
	}
	console.log($("#report_page tr").length);
})
